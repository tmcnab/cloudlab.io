...
namespace Server.Models
{
    ...
    [Serializable]
    sealed public class DataProcessor
    {
        #region Members
        ...
        public DataProcessor(IPrincipal user)
        {
            this.Username = user.Identity.Name;
            this.JSEngine = Jurassic.Numerics.Configurator.New();
            this.JSEngine.SetGlobalValue("System", new SystemObject(this.JSEngine, user.Identity.Name));
        }
